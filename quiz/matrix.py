...
print("Hasil A * C (dengan NumPy):\n", hasil_A_C)
print("Hasil A * D (dengan modifikasi, NumPy):\n", hasil_A_D)
print("Hasil D + E (dengan NumPy):\n", hasil_D_plus_E)
print("Hasil D - E (dengan NumPy):\n", hasil_D_minus_E)
...
tampilkan_matriks(hasil_A_C_no_numpy)

print("\nHasil A * D (dengan modifikasi) tanpa NumPy:")
tampilkan_matriks(hasil_A_D_no_numpy)

print("\nHasil D + E tanpa NumPy:")
tampilkan_matriks(hasil_D_plus_E_no_numpy)

print("\nHasil D - E tanpa NumPy:")
tampilkan_matriks(hasil_D_minus_E_no_numpy)
